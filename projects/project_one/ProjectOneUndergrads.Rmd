...
0. (5 pts) Create a directory called `projects`, and in it, a subdirectory called `project_one`. Use `download.files` to get this file, and this one.
...
12. (15 pts) Produce a histogram of the number of specimens by minimum age
